...
public class Main {
    public static void main(String[] args) {
        ...
        // Все созданные команды отдаю Интенданту. В свою очередь Органайзер, случайным образом выбирает
        // полосу препятствий из массива препятствий, которую должна пройти команда. И также отдаем ее
        // Интенданту
